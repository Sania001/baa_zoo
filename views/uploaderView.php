    ...
    <section id="main_up">
        ...
        <form name="upload" action="" method="post" enctype="multipart/form-data">
           <a id="pre_foto_up" href="<?php echo $path ?>">
            ...
            <input type="text" maxlength="50" id="name_up" name="name_up" placeholder="введите имя работы" />
            <textarea id="com_up" maxlength="250" placeholder="введите обязательный комментарий" name="com_up"></textarea><br/>
